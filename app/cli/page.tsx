...
export default function CliPage() {
  ...
  const installationSteps = [
    ...
    {
      text: "   nexlayer templates   # Deploy a template app",
      color: "#22B4C8",
    },
    {
      text: "   nexlayer init        # Initialize in existing project",
      color: "#22B4C8",
    },
    {
      text: "   nexlayer deploy      # Deploy your prepared project",
      color: "#22B4C8",
    },
    { text: "", color: "#FFFFFF" },
    {
      text: "✨ NEW: Enjoy our vibey UI experience with simplified output!",
      color: "#FFD700",
    },
    {
      text: "   (Use --verbose for detailed technical information)",
      color: "#FFD700",
    },
    { text: "", color: "#FFFFFF" },
    {
      text: "💡 Run nexlayer --help to see all available commands",
      color: "#FFFFFF",
    },
  ];
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Let Nexlayer handle infrastructure while you build what matters",
    },
    {
      icon: <Database className="h-8 w-8 text-[#22B4C8]" />,
      title: "Integrate any AI model",
      description:
        "Seamless support for OpenAI, Anthropic, Hugging Face, and more",
    },
    {
...
╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═╝`}
        ...
        <div className="text-[#22B4C8] mb-4">
          From prompt to production — Ship AI products that scale faster.
        </div>

        <div className="space-y-1">
          {installationSteps
            .slice(0, installationStep + 1)
            .map((step, index) => (
              <div key={step.text + index} className="flex">
                <span style={{ color: step.color }}>{step.text}</span>
                {index === installationStep && step.text && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8 p-6 bg-amber-100 dark:bg-amber-900 border-l-4 border-amber-500 rounded-md">
          ...
          <p className="text-amber-800 dark:text-amber-200 font-medium">
            This CLI is part of an early Research Preview Beta. We're sharing it
            now to learn — from real use, real feedback, and real-world edge
            cases.
          </p>
          <p className="text-amber-800 dark:text-amber-200 font-medium mt-2">
            It's not perfect yet. You may notice bugs or unfinished edges.
            That's by design.
          </p>
          <p className="text-amber-800 dark:text-amber-200 font-medium mt-2">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl">
            Deploy AI apps to production in seconds with our powerful
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-3xl font-light mb-6 text-white">
              <span className="gradient-text">Zero to deployed</span> in 5
              minutes
            </h2>
            <p className="text-gray-300 mb-8">
              Nexlayer CLI transforms the complex process of deploying
              AI-powered applications into a single command, giving developers
              the ability to ship production-grade applications in minutes
              rather than weeks.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="app.nexlayer.io" target="_blank">
              ...
              <Link
                href="https://github.com/Nexlayer/nexlayer-cli"
                target="_blank"
              >
                <Button
                  variant="outline"
            ...
            <div className="bg-[#0a0a0a] rounded-xl p-6 border border-[#333]">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[#22B4C8] mt-2 text-center">
              ...
              {features.map((feature) => (
                <motion.div
                  ...
                  transition={{
                    duration: 0.4,
                    delay:
                      features.findIndex((f) => f.title === feature.title) *
                      0.1,
                  }}
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {commonCommands.map((cmd) => (
                  ...
                  >
                    <div className="font-mono text-[#22B4C8]">
                      {cmd.command}
                    </div>
        ...
        {/* Deployment Steps */}
        <div className="mb-16">
          <h2 className="text-2xl font-light mb-8 text-center gradient-text">
            ...
            {deploymentSteps.map((step) => (
              <motion.div
                ...
                transition={{
                  duration: 0.5,
                  delay:
                    deploymentSteps.findIndex((s) => s.title === step.title) *
                    0.1,
                }}
              ...
              >
                ...
                <h3 className="text-lg font-medium mb-2 text-white mt-2">
                  {step.title}
                </h3>
        ...
        <div className="bg-[#0a0a0a] rounded-xl p-8 border border-[#333] mb-16">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-light mb-4 gradient-text">
              Ready to simplify your AI deployments?
            </h2>
            <p className="text-gray-300 mb-6">
              Get started with Nexlayer CLI today and deploy your AI
              applications to production in seconds.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#0a0a0a] rounded-xl p-6 border border-[#333]">
              ...
              <p className="text-gray-300 mb-4">
                For enterprise support options, dedicated resources, and SLAs,
                please contact our enterprise team.
              </p>
              <Link href="mailto:sales@nexlayer.com ">
                <Button
                  variant="outline"
                  className="border-[#333] hover:border-[#22B4C8] w-full"
                >
